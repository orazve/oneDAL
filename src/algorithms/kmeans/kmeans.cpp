...
protected:
    void set_algorithm() final {
        ...
        this->algorithm_ = std::make_unique<AlgorithmType>(
            AlgorithmType(params_.num_clusters, params_.num_iterations));
    }
    ...
    void set_input() final {
        ...
        NumericTablePtr centroids =
            init.getResult()->get(daal::algorithms::kmeans::init::centroids);
