...
struct graph_matching_ops_dispatcher {
    graph_matching_result<Task> operator()(const Context&,
                                           const descriptor_base<Task>&,
                                           const graph_matching_input<Task>&) const;
};
...
struct graph_matching_ops {
    ...
    using input_t = graph_matching_input<task_t>;
    ...
    auto operator()(const Context& ctx, const Descriptor& desc, const input_t& input) const {
        ...
        const auto result =
            graph_matching_ops_dispatcher<Context, float_t, method_t, task_t>()(ctx, desc, input);
